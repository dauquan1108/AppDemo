        ...
        return (
            <ScrollView>
                <View style={styles.HeaderGroup}>
                    <HeaderGroup navigation={navigation} title="Chỉnh sửa thông tin cá nhân"/>

                    <View style={styles.Content}>
                        {/*<View style={styles.Border}/>*/}
                        <View style={styles.Avatar}>
                            <View style={styles.AvatarText}>
                                <Text style={{fontWeight: 'bold', fontSize: 20}}>Ảnh đại diện </Text>
                                <TouchableOpacity>
                                    <Text>Chỉnh sửa</Text>
                                </TouchableOpacity>
                            </View>
                        ...
                        <View style={styles.Titles}>
                            <Text style={{fontWeight: 'bold', fontSize: 20}}>Cấu hình trang cá nhân</Text>
                            ...
                            <View style={styles.TitlesList}>
                                ...
                                <View style={styles.TitlesListContent}>
                                    <Text>Ai có xem nội dung mà người khác đã đăng lên dòng thời gian của bạn?</Text>
                                </View>
                                <View style={styles.TitlesListTitle}>
                                    <Text style={{color: 'blue'}}>Bạn bè</Text>
                                </View>
                            ...
                            <View style={styles.TitlesList}>
                                ...
                                <View style={styles.TitlesListContent}>
                                    <Text>Xét duyệt bài viết bạn bè gắn thẻ trước khi bài viết xuất hiện trên dòng thời
                                        gian cảu bạn?</Text>
                                </View>
                                <View style={styles.TitlesListTitle}>
